...
// img
// import creditcard from "../assets/img/creditcard.webp";
        ...
        <div className="row mb-5" id="hero-section">
          <div className="col-lg-12 d-flex flex-wrap flex-sm-wrap flex-md-wrap justify-content-between">
            ...
            <div className="col-lg-6">
              <img
                src="https://static.vecteezy.com/system/resources/previews/007/383/883/non_2x/person-paying-online-bill-flat-illustration-of-invoice-payments-vector.jpg"
                alt=""
                width={'650px'}
        ...
        <div className="row mb-5" id="contact">
          <div className="col-lg-12 mt-5 d-flex flex-wrap justify-content-between flex-md-wrap flex-sm-wrap">
            <div className="col-lg-5 map">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118147.82106511467!2d70.7388944931172!3d22.27346616666724!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3959c98ac71cdf0f%3A0x76dd15cfbe93ad3b!2sRajkot%2C%20Gujarat!5e0!3m2!1sen!2sin!4v1728301012026!5m2!1sen!2sin"
                allowfullscreen=""
                loading="lazy"
